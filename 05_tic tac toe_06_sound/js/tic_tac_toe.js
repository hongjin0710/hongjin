...
const suqareArray = Array.from(squares)
...
const line1 = JudgLine(suqareArray,["a_1","a_2","a_3"])
const line2 = JudgLine(suqareArray,["b_1","b_2","b_3"])
const line3 = JudgLine(suqareArray,["c_1","c_2","c_3"])
const line4 = JudgLine(suqareArray,["a_1","b_1","c_1"])
const line5 = JudgLine(suqareArray,["a_2","b_2","c_2"])
const line6 = JudgLine(suqareArray,["a_3","b_3","c_3"])
const line7 = JudgLine(suqareArray,["a_1","b_2","c_3"])
const line8 = JudgLine(suqareArray,["a_3","b_2","c_1"])
...
function isSelect(selctSquare){
    if(flag === "pen-flag"){
        ...
        selctSquare.classList.add("js-pen-checked")
        selctSquare.classList.add("js-unclickable")
        ...
        selctSquare.classList.add("js-bear-checked")
        selctSquare.classList.add("js-unclickable")
...
function setMessage(id){
    let msgtxt = document.getElementById("msgtext")

    switch(id){
        case "pen-turn":
            msgtxt.innerHTML = msgtxt1
            break
        case "bear-turn":
            msgtxt.innerHTML = msgtxt2
            break
        case "pen-win":
            msgtxt.innerHTML = msgtxt3
            break
        case "bear-win":
            msgtxt.innerHTML = msgtxt4
            break
        case "draw":
            msgtxt.innerHTML = msgtxt5
            break
        default:
            msgtxt.innerHTML = msgtxt1
    }
...
function gameOver(status){
    ...
    suqareArray.forEach(function(square){
